 ...
 */
function hook_smart_content_segmentio_info() {
  return [
    'example:smart_content_segmentio_mytrackinginfo' => t("MyModule's MyTrackingInfo"),
  ];
}
 ...
 */
function example_smart_content_segmentio_mytrackinginfo(&$variables = []) {
  // Identify the user.
  ...
  $variables['page']['properties']['keywords'][] = "Keyword1";
  $variables['page']['properties']['variants'][] = "interest_label";
