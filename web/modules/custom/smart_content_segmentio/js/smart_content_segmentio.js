/**
 * @file
 * smart_content_segmentio Tracking Code.
 */
...
(function ($, Drupal, drupalSettings) {
    ...
    Drupal.behaviors.smart_content_segmentio = {
        attach: function (context) {
            $('body', context).once('track-page-load').each(function () {
                ...
                analytics.load(drupalSettings.smart_content_segmentio.smart_content_segmentio.write_key);

                var segmentVars = drupalSettings.smart_content_segmentio.smart_content_segmentio.variables;
                // Identify users.
